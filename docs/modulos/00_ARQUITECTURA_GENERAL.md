...
| --- | --- | --- |
| `administracion` | `Datos de la cooperadora` | datos base, ejercicio, banco y kiosco/libreria |
| `socios` | `Socios` | padron e historial minimo de socios |
| `autoridades_asamblea` | `Autoridades y asamblea` | asambleas, cargos y autoridades |
