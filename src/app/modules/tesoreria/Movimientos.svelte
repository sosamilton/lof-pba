<script>
  ...
  import { normalize, buildMapById } from '$core/utils'
  ...
  import MovimientosList from './parts/MovimientosList.svelte'
  import MovimientoForm from './parts/MovimientoForm.svelte'
