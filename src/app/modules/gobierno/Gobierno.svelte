<script>
  ...
  import { gobiernoStore as store } from './gobiernoStore.svelte'
  import { isInGrist, subscribeRecords } from '$core/grist'
...
<PageScaffold title="Gobierno" loading={store.loading} error={store.error} notice={store.notice}>
  {#snippet skeleton()}
              ...
              <Card.Root>
                ...
                <Card.Content class="flex flex-col gap-4">
                  <div class="grid gap-4 sm:grid-cols-2">
                    <FormField label="Fecha" id="as-fecha" type="date" bind:value={store.asambleaForm.fecha} />
                    <div>
                      <Label for="as-tipo">Tipo</Label>
                      <Select.Root type="single" bind:value={store.asambleaForm.tipo_asamblea}>
                        <Select.Trigger id="as-tipo" class="mt-1 w-full">
                          <Select.Value placeholder="Elegir…" />
                        </Select.Trigger>
                        <Select.Content>
                          <Select.Item value="AnualOrdinaria">Anual ordinaria</Select.Item>
                          <Select.Item value="Extraordinaria">Extraordinaria</Select.Item>
                        </Select.Content>
                      </Select.Root>
                    </div>
                    <FormField label="Acta N°" id="as-acta" bind:value={store.asambleaForm.acta_numero} />
                    <FormField label="Fojas" id="as-fojas" bind:value={store.asambleaForm.acta_fojas} />
                    <FormField label="Presentes" id="as-presentes" type="number" bind:value={store.asambleaForm.socios_presentes_cantidad} />
                    <FormField label="Cuota social ($)" id="as-cuota" type="number" bind:value={store.asambleaForm.cuota_social_importe} />
                    <div>
                      <Label for="as-modalidad">Cuota modalidad</Label>
                      <Select.Root type="single" bind:value={store.asambleaForm.cuota_social_modalidad}>
                        <Select.Trigger id="as-modalidad" class="mt-1 w-full">
                          <Select.Value placeholder="Elegir…" />
                        </Select.Trigger>
                        <Select.Content>
                    ...
                    <FormField label="Caja chica ($)" id="as-caja" type="number" bind:value={store.asambleaForm.caja_chica_importe} />
                  </div>
