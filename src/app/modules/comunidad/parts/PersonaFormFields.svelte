<script>
  ...
  import { localidadesItems } from '$core/personas'
...
<Field.Field data-invalid={Boolean(cuilWarning)}>
  ...
  <Input id="cuil" bind:value={form.cuil} oninput={onCuilInput} aria-invalid={Boolean(cuilWarning)} placeholder="20-12345678-9" inputmode="numeric" />
...
<Field.Field data-invalid={Boolean(telefonoWarning)}>
  ...
  <Input id="telefono" bind:value={form.telefono} oninput={onTelefonoInput} aria-invalid={Boolean(telefonoWarning)} placeholder="+54 9 11 1234-5678" inputmode="tel" />
